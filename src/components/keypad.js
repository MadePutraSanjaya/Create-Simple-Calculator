  ...
  render() {
      return (
          <div className="button">
              <button className='grey' name="AC" onClick={e => this.props.onClick(e.target.name)}>AC</button>
              <button className='grey' name="CE" onClick={e => this.props.onClick(e.target.name)}>CE</button>
